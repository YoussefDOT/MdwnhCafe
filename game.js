...
function confirmJoinCoopSession() {
    ...
    // Teleport to a slot near the host's laptop
    const myIdx = sp.activeGroupMembers.indexOf(gameState.userId);
    const slotOffset = (myIdx - (sp.activeGroupMembers.length - 1) / 2) * 55;
