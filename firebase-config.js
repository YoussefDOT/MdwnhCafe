...
import { getDatabase, ref, onValue, update, get, onDisconnect, set } from "https://www.gstatic.com/firebasejs/10.8.0/firebase-database.js";
...
export { database, ref, onValue, update, get, onDisconnect, set };
